<?require_once($_SERVER['DOCUMENT_ROOT'] . '/server-scripts/index.php');?>

<?include_once($_SERVER['DOCUMENT_ROOT'] . '/static-views/header.php');?>

<div class="row">
    <div class="col">
        <div class="content-notification mt-5">
            <h3 class="mb-3">Фортепиано — не самый простой для освоения инструмент, но точно один из самых интересных.</h3>
            <p class="notification-description font-arial-sserif">На нем можно играть в совершенно разных музыкальных стилях, придумывать по-настоящему лиричные каверы и писать потрясающую музыку: Pianoboy и Евгений Хмара уже не раз доказывали это нам.</p>
            <p class="notification-description font-arial-sserif">Конечно, в одиночку научиться играть на фортепиано очень трудно. Именно поэтому стоит обратиться за помощью к нашим опытным педагогам: они научат игре на фортепиано и детей, и взрослых!</p>
        </div>
    </div>
</div>
<div class="row mt-5 mb-5">
    <div class="col">
        <div class="card-deck">
            <div class="card">
                <div class="card-avatar card-avatar-advantages advantage-1"></div>
                <div class="card-body">
                    <h5 class="card-title">Эффективность</h5>
                    <p class="card-text">Эффективное обучение которому нет аналогов в Европе.</p>
                </div>
            </div>
            <div class="card">
                <div class="card-avatar card-avatar-advantages advantage-2"></div>
                <div class="card-body">
                    <h5 class="card-title">Стабильность</h5>
                    <p class="card-text">Уверенность в высокой востребованности.</p>
                </div>
            </div>
            <div class="card">
                <div class="card-avatar card-avatar-advantages advantage-3"></div>
                <div class="card-body">
                    <h5 class="card-title">Честность</h5>
                    <p class="card-text">Гарантия честности как в старые, добрые времена.</p>
                </div>
            </div>
        </div>
    </div>
...
Если классическая музыка тебе по душе, выбирай именно это направление обучения!</p>
                </div>
            </div>
        </div>
    </div>
...
<div class="row">
    <div class="col">
        <div class="row mt-3 mb-3">
            <div class="col font-monospace categories-point-headline">Преподаватели:</div>
        </div>
...
<div class="row">
    <div class="col">
        <div class="row mt-3 mb-3">
            <div class="col font-monospace categories-point-headline">В результате обучения игре на фортепиано ты сможешь:</div>
        </div>
